...
void printf_bgcolor(int color) {
  ...
  case BLACK:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_BLACK);
    break;
  case RED:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_RED);
    break;
  case GREEN:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_GREEN);
    break;
  case YELLOW:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_YELLOW);
    break;
  case BLUE:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_BLUE);
    break;
  case MAGENTA:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_MAGENTA);
    break;
  case CYAN:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_CYAN);
    break;
  case WHITE:
    printf(ANSI_COLOR_RESET);
    printf(ANSI_BGCOL_WHITE);
    break;
  case BOLD_BLACK:
    printf(ANSI_COLOR_BOLD);
    printf(ANSI_BGCOL_BLACK);
...
void printf_reset_color() { printf(ANSI_COLOR_RESET); }
...
void borrar_pantalla() { printf("\e[1;1H\e[2J"); }